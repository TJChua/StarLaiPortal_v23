...
namespace StarLaiPortal.Module.Controllers
{
    ...
    public partial class InquiryViewControllers : ViewController
    {
        ...
        public InquiryViewControllers()
        {
            ...
            ChoicePreviewOption.Items.Add(PreviewInvoice);
            // End ver 1.0.29
        }
        ...
        private void InquirySearch_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            ...
            if (View.ObjectTypeInfo.Type == typeof(SalesOrderInquiry))
            {
                ...
                if (!string.IsNullOrEmpty(currObject.PortalSQ))
                {
                    PortalSQ = currObject.PortalSQ;
                }

                if (!string.IsNullOrEmpty(currObject.SAPNo))
                {
                    SAPSO = currObject.SAPNo;
                }
